...
## Correzione caricamento in progetti con alias (15 settembre 2026)

Causa verificata: il percorso selezionato del progetto è un collegamento simbolico alla directory reale. La validazione dell’archivio rifiutava il collegamento del progetto insieme a quelli interni. Risolto soltanto il percorso del progetto per la disposizione `project`, condividendo la risoluzione tra salvataggio e gestore allegati. Nessuna migrazione o modifica degli originali.

RED osservato nel test con progetto simbolico; GREEN su upload, consultazione, eliminazione e rifiuto di un collegamento nella cartella telegram. Suite completa: 318 test passati, 1026 asserzioni; typecheck e diff-check superati, formatter con soli due avvisi preesistenti. La risoluzione del percorso operativo è stata controllata senza scrivere file nel progetto.
